...
const controller_association_create = class extends Controller {
    ...
    addCreateButton(field) {
        ...
        const placeholder = field.tomselect.control.querySelector('.items-placeholder');

        if (placeholder) {
            placeholder.style.width = 'calc(100% - 40px)';
        }
    }
...
export {
    controller_association_create as default
};
